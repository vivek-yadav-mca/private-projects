...
import com.zero07.rssb.databinding.ActivityPdfViewerBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView pdfWebView, String url) {
                ...
                dialog.dismiss();
//                binding.pdfWebViewProgessBar.setVisibility(View.GONE);
...
//        binding.pdfWebView.loadUrl("https://docs.google.com/gview?embedded=true&url="+BookActivity.bookModels.get(position).getpdfContentUrl());

//        String url = getIntent().getStringExtra("url");
//        binding.pdfWebView.loadUrl("https://docs.google.com/gview?embedded=true&url=" + url);


//        String pdf = "https://99story.in/wp-content/uploads/2021/06/Vaishnov-Bhojan-3.pdf";
//        binding.pdfWebView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=" + pdf);
