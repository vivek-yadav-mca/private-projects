package com.zero07.rssb.forceUpdate;
...
public class ForceUpdateChecker {
    ...
    public static final String KEY_UPDATE_MESSAGE_HI = "force_update_message_hi";
    public static final String KEY_UPDATE_MESSAGE_EN = "force_update_message_en";
