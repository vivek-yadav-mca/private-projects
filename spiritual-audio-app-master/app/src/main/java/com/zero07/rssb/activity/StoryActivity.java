...
import com.zero07.rssb.adapters.StoryAdapter;
import com.zero07.rssb.databinding.ActivityStoryBinding;
...
//        storyModels.add(new StoryModel("test1", "test_story_name", "https://99story.in/wp-content/rssbShabad/homeItems/shabad.png", "https://99story.in/"));
//        storyModels.add(new StoryModel("test2", "test_story_name2", "https://99story.in/wp-content/rssbShabad/homeItems/satsang.png", "http://www.example.com"));
