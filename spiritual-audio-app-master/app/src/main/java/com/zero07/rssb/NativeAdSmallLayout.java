...
public class NativeAdSmallLayout extends ConstraintLayout {
...
//    private TextView mSubtitleTextView;
    ...
    public NativeAdSmallLayout(Context context) {
        super(context);
        mInflater = LayoutInflater.from(context);
        init();
    }

    public NativeAdSmallLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mInflater = LayoutInflater.from(context);
        init();
    }

    public NativeAdSmallLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        View v = mInflater.inflate(R.layout.layout_native_small_ad, this, true);

        mTitleView = v.findViewById(R.id.small_native_title);
//        mSubtitleTextView = v.findViewById(R.id.native_subtitle);
        mBodyTextView = v.findViewById(R.id.small_native_body_textView);
//        mCaptionTextView = v.findViewById(R.id.caption_textview);
//        mImageView = v.findViewById(R.id.small_native_image_View);
        mButtonTv = v.findViewById(R.id.small_native_cta_Button);
        mAdChoicesView = v.findViewById(R.id.small_native_adChoices);
        mIconView = v.findViewById(R.id.small_native_icon_View);
...
//        mMediaView = v.findViewById(R.id.small_native_media_View);
//        mAdview = v.findViewById(R.id.small_native_ad_View);
    }
...
//            }
            ...
            mButtonTv.setText(ad.getCallToAction());
            ad.registerView(mButtonTv);
