...
public class Constants {
    ...
    public static final String APP_PLAYSTORE_LINK = "https://play.google.com/store/apps/details?id=com.o2games.playwin.android";
...
//    public static final String GET_UPSTOX_REFERRAL_LINK = "getUpstoxReferralLink";
//    public static final String GET_QUREKA_LINK = "getQurekaLink";
//    public static final String GET_GAMEZOP_LINK = "getGamezopLink";
//    public static final String IS_CPA_LEAD_OFFERWALL_enabled = "isCPALeadOfferwall_enabled";
//    public static final String GET_CPA_LEAD_OFFERWALL_LINK = "getCPALeadOfferwallLink";


//    public static final String IS_ADMOB_ENABLED = "isAdmob_enabled";
//    public static final String IS_ADMOB_BANNER = "isAdmob_banner";
//    public static final String IS_ADMOB_INTERSTITIAL = "isAdmob_interstitial";
//    public static final String IS_ADMOB_REWARDED = "isAdmob_rewarded";
//
//    public static final String IS_TAPDAQ_ENABLED = "isTapjoy_enabled";
//    public static final String IS_TAPDAQ_BANNER = "isTapdaq_banner";
//    public static final String IS_TAPDAQ_INTERSTITIAL = "isTapdaq_interstitial";
//    public static final String IS_TAPDAQ_REWARDED = "isTapdaq_rewarded";
//    public static final String IS_TAPDAQ_NATIVE = "isTapdaq_native";

//    public static final String GET_TAPJOY_SDK_KEY = "getTapjoy_sdkKey";
...
//    public static final String IS_APPLOVIN_SMALL_NATIVE = "isAppLovin_native_small";
    public static final String IS_APPLOVIN_MEDIUM_NATIVE = "isAppLovin_native_medium";
//    public static final String IS_APPLOVIN_MANUAL_NATIVE = "isAppLovin_native_manual";
...
//    public static final String IS_UNITY_ENABLED = "isUnity_enabled";
//    public static final String IS_UNITY_BANNER = "isUnity_banner"; // Unity don't provide banner in mediation
//    public static final String IS_UNITY_INTERSTITIAL = "isUnity_interstitial";
//    public static final String IS_UNITY_REWARDED = "isUnity_rewarded";
//
//    public static final String IS_IRONSOURCE_ENABLED = "isIronsource_enabled";
//    public static final String IS_IRONSOURCE_OFFERWALL = "isIronsource_offerwall";
    /***** FB Remote Config Key *****/
...
//    public static final String SHARED_PREF_AUTO_INTERSTITIAL = "o2_auto_interstitial";
