...
//        return dbHelper.getFreeAdGameDataByUserIdAndGameId(loggedInUser.getId(), gameEnum).getChanceLeft();
...
//        return dbHelper.getFreeAdGameDataByUserIdAndGameId(loggedInUser.getId(), sqlTotal_CashCoinsCOL).getCoins();
...
//        String updateUserCoinPath =
//                "/" + Constants.LEADERBOARD_TABLE +
//                        "/" + loggedInUser.getAuthUid() +
//                        "/" + Constants.LEADERBOARD_CHILD_USERCOIN_NAME;
//
//        updateChildren.put(updateUserCoinPath, finalTotalCoins);
//        databaseRef.updateChildren(updateChildren);
...
//        return dbHelper.getFreeAdGameDataByUserIdAndGameId(loggedInUser.getId(), sqlTotal_CashCoinsCOL).getCash();
...
////        childUpdates.put("/user-posts/" + userId + "/" + key, postValues);
//        String updateUserCoinPath =
//                "/" + Constants.USER_WALLET +
//                        "/" + loggedInUser.getAuthUid() +
//                        "/" + Constants.USER_WALLET_CHILD_AMT_NAME;
//
//        updateChildren.put(updateUserCoinPath, finalTotalCash);
//        databaseRef.updateChildren(updateChildren);
